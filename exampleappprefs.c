...
static void example_app_prefs_class_init(ExampleAppPrefsClass *class)
{
    ...
    gtk_widget_class_set_template_from_resource(GTK_WIDGET_CLASS(class), "/net/bingliu/exampleapp/prefs.ui");
...
{
    return g_object_new(EXAMPLE_APP_PREFS_TYPE, "transient-for", win, "use_header_bar", TRUE, NULL);
}
